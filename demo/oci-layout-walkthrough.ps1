...
'@)
    ...
    Invoke-CheckedCommand 'cargo' @('run', '-q', '--', 'validate', $catalogJson)
    ...
    Invoke-CheckedCommand 'cargo' @('run', '-q', '--', 'validate', $roundtripJson)
